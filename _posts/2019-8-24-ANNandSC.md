...
preprint: ["Two-hidden-layer Feedforward Neural Networks are Universal Approximators: A Constructive Approach"](https://arxiv.org/pdf/1907.11457.pdf) (already published [(Eduardo Paluzo-Hidalgo, Rocio Gonzalez-Diaz, Miguel A. Gutiérrez-Naranjo,
Two-hidden-layer feed-forward networks are universal approximators: A constructive approach,
Neural Networks,
Volume 131,
2020)](https://doi.org/10.1016/j.neunet.2020.07.021)).
